...
public class BufferReaderWriter {
    public static void main(String[] args) {
        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter("E:\\ideaCodes\\javaBase\\src\\main\\java\\bufferWriterReader.txt"));
            ...
            BufferedReader br = new BufferedReader(new FileReader("E:\\ideaCodes\\javaBase\\src\\main\\java\\bufferWriterReader.txt"));
